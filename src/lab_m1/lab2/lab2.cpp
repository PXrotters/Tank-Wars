...
void Lab2::Init()
{
    ...
    // Create a mesh box using custom data
    {
        vector<VertexFormat> vertices
        {
            ...
            VertexFormat(glm::vec3(-1,  1,  1), glm::vec3(1, 0, 0)),  // 2
            VertexFormat(glm::vec3(1,  1,  1), glm::vec3(1, 0, 0)),  // 3

            // Spate
            VertexFormat(glm::vec3(-1, -1, -1), glm::vec3(0, 1, 0)),  // 4
            VertexFormat(glm::vec3(1, -1, -1), glm::vec3(0, 1, 0)),  // 5
            VertexFormat(glm::vec3(-1,  1, -1), glm::vec3(0, 1, 0)),  // 6
            VertexFormat(glm::vec3(1,  1, -1), glm::vec3(0, 1, 0)),  // 7

            // Sus
            VertexFormat(glm::vec3(-1,  1,  1), glm::vec3(0, 0, 1)),  // 8
            VertexFormat(glm::vec3(1,  1,  1), glm::vec3(0, 0, 1)),  // 9
            VertexFormat(glm::vec3(-1,  1, -1), glm::vec3(0, 0, 1)),  // 10
            VertexFormat(glm::vec3(1,  1, -1), glm::vec3(0, 0, 1)),  // 11

            // Jos
            VertexFormat(glm::vec3(-1, -1,  1), glm::vec3(1, 1, 0)),  // 12
            VertexFormat(glm::vec3(1, -1,  1), glm::vec3(1, 1, 0)),  // 13
            VertexFormat(glm::vec3(-1, -1, -1), glm::vec3(1, 1, 0)),  // 14
            VertexFormat(glm::vec3(1, -1, -1), glm::vec3(1, 1, 0)),  // 15

            // Stanga
            VertexFormat(glm::vec3(-1, -1,  1), glm::vec3(1, 0, 1)),  // 16
            VertexFormat(glm::vec3(-1,  1,  1), glm::vec3(1, 0, 1)),  // 17
            VertexFormat(glm::vec3(-1, -1, -1), glm::vec3(1, 0, 1)),  // 18
            VertexFormat(glm::vec3(-1,  1, -1), glm::vec3(1, 0, 1)),  // 19

            // Dreapta
            VertexFormat(glm::vec3(1, -1,  1), glm::vec3(0, 1, 1)),  // 20
            VertexFormat(glm::vec3(1,  1,  1), glm::vec3(0, 1, 1)),  // 21
            VertexFormat(glm::vec3(1, -1, -1), glm::vec3(0, 1, 1)),  // 22
            VertexFormat(glm::vec3(1,  1, -1), glm::vec3(0, 1, 1)),  // 23
        };
...

    {
        ...
        {
            VertexFormat(glm::vec3(0, 1, 0), glm::vec3(1, 0, 0)),    // Vertex 0
            VertexFormat(glm::vec3(-1, -1, -1), glm::vec3(0, 1, 0)), // Vertex 1
            VertexFormat(glm::vec3(1, -1, -1), glm::vec3(0, 0, 1)),  // Vertex 2
            VertexFormat(glm::vec3(0, -1, 1), glm::vec3(1, 1, 0))    // Vertex 3
        };
...

    {
        ...
        {
            VertexFormat(glm::vec3(0, 0, 0), glm::vec3(1, 0, 0)),  // Vertex 0
            VertexFormat(glm::vec3(0, 1, 0), glm::vec3(0, 1, 0)),  // Vertex 1
            VertexFormat(glm::vec3(0, 1, 1), glm::vec3(0, 0, 1)),  // Vertex 2
            VertexFormat(glm::vec3(0, 0, 1), glm::vec3(1, 1, 0))   // Vertex 3
        };
...
void Lab2::Update(float deltaTimeSeconds)
{
    ...
    RenderMesh(meshes["tetrahedron"], shaders["VertexColor"], glm::vec3(-3.0f, 0.5f, 0), glm::vec3(0.5f));

    // TODO(student): Draw the square
    RenderMesh(meshes["square"], shaders["VertexColor"], glm::vec3(1, 0, 1.5f), glm::vec3(1.0f));
