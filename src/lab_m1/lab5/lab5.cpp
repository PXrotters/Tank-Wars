...
void Lab5::Init()
{
    ...
    // original line: projectionMatrix = glm::perspective(RADIANS(60), window->props.aspectRatio, 0.01f, 200.0f);
    fov = 60;
...
void Lab5::Update(float deltaTimeSeconds)
{
    ...
    {
        // New object 1: cutie scalata si rotita la dreapta
        glm::mat4 modelMatrix = glm::mat4(1);
    ...
    {
        // New object 2: sfera translatata la dreapta
        glm::mat4 modelMatrix = glm::mat4(1);
        modelMatrix = glm::translate(modelMatrix, glm::vec3(4, 0.5f, 0));
