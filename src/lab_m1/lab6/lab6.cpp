...
void Lab6::RenderSimpleMesh(Mesh *mesh, Shader *shader, const glm::mat4 & modelMatrix)
{
    ...
    const auto modelLocation = glGetUniformLocation(shader->program, "Model");

    // TODO(student): Set shader uniform "Model" to modelMatrix
    glUniformMatrix4fv(modelLocation, 1, GL_FALSE, glm::value_ptr(modelMatrix));

    // TODO(student): Get shader location for uniform mat4 "View"
    const auto viewLocation = glGetUniformLocation(shader->program, "View");
    ...
    const auto projLocation = glGetUniformLocation(shader->program, "Projection");
    ...
    const auto timeLocation = glGetUniformLocation(shader->program, "Time");
